...
Person.create(name:"Ana", lastname:"Pérez de Velasco Geldres", identity_document: Faker::Number.number(digits: 8),nationality:"Peru", birthdate:"25-01-1994",avatar: { io: File.open('db/seeds_images/p_1.jpg'), filename: 'p_1.jpg' })
...
Person.create(name:"Jeancarlo", lastname:"Bolaños Rueda", identity_document: Faker::Number.number(digits: 8),nationality:"Peru", birthdate:"25-01-1994",avatar: { io: File.open('db/seeds_images/p_9.jpg'), filename: 'p_9.jpg' })